...
function weather() {
  ...
  <p>
  <input type="button" onclick="location.assign('/ctlg/05/pseudo-world-tour/')" value="疑似世界旅行"/>
  </p>
  `
...
function menu() {
  ...
  <input type="button" onclick="location.assign('/ctlg/05/1APR18SUN')" value="観客参加型即興セッション"/>
  </p>
  <p>8:00 pm : end</p>
  `
  changeHidden()
